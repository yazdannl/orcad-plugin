# orcad — build123d CAD tab for OrcaSlicer (v0.4)
...
3. Restart OrcaSlicer. Plugins dialog should list **orcad 0.4.0** with capability **orcad** (type Pages). Enable it.
4. An **orcad** tab appears in the top tab bar. Open it: left side switches between
   **Objects** (searchable dropdown, Gridfinity Bin preselected, live preview as
   you drag sliders) and **Code Editor** (Monaco); right side always shows the 3D preview.
