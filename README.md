# orcad — build123d CAD tab for OrcaSlicer (v0.3)
...
3. Restart OrcaSlicer. Plugins dialog should list **orcad 0.3.0** with capability **orcad** (type Pages). Enable it.
...
6. Exports land in `.../orca_plugins/orcad/exports/`. Drag one onto Prepare → it loads as a model.
